				...
				<div className="page-content" key="1">
					...
					<Form
						...
						{isLoading ? (
							...
							<Row gutter={16}>
								<Col xs={24} lg={18}>
									<Form.Item name="create_account" label="E-mail para receber alertas de criação de conta" 	hasFeedback rules={[
									...
									<Form.Item name="delete_account" label="E-mail para receber alertas de remoção de conta" hasFeedback rules={[
										{required: true, message: "Campo obrigatório."},
										({getFieldValue}) => ({
											validator(rule, value) {
												if( !value )
