...
import { Button, Modal, Radio, Form, DatePicker, Select, Spin } from "antd";
...
class Filters extends Component {
	...
	render() {
		...
		const {filters, categoriaIsLoading, categorias} = this.state;
					...
					<div className="filter-group-filters" style={{paddingBottom: 0}}>
						<Form.Item name="store_id">
							<Select
								filterOption={false}
								allowClear
								onChange={(e) => this.setFilter("categoria_id", e.value)}
								showSearch
								labelInValue={true}
